        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScheduleSlots_SchoolClasses_SchoolClassId",
                        column: x => x.SchoolClassId,
                        principalTable: "SchoolClasses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateUnix = table.Column<long>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SchoolEvents_SchoolClasses_SchoolClassId",
                        column: x => x.SchoolClassId,
                        principalTable: "SchoolClasses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SchoolEvents_Teachers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Teachers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubjectAssignments_SchoolClasses_SchoolClassId",
                        column: x => x.SchoolClassId,
                        principalTable: "SchoolClasses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleSlots_SchoolClassId",
                table: "ScheduleSlots",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SchoolClasses_Name_SchoolYear",
                table: "SchoolClasses",
                columns: new[] { "Name", "SchoolYear" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SchoolEvents_SchoolClassId",
                table: "SchoolEvents",
                column: "SchoolClassId");

            migrationBuilder.CreateIndex(
                name: "IX_SchoolEvents_TeacherId",
                table: "SchoolEvents",
                column: "TeacherId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubjectAssignments_SchoolClassId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubjectAssignments_TeacherId_SubjectId_SchoolClassId",
                table: "SubjectAssignments",
